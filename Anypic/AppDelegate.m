    ...
    if (application.applicationIconBadgeNumber != 0) {
        ...
        if(application.applicationIconBadgeNumber == 1 && [self.konotorCount intValue] > 0){
            ...
            if ([self.tabBarController viewControllers].count > PAPActivityTabBarItemIndex) {
                ...
                [self.activityViewController notificationSetup:application.applicationIconBadgeNumber];
...
- (void)presentTabBarController {
    ...
    if ([UIApplication sharedApplication].applicationIconBadgeNumber != 0) {
        if ([self.tabBarController viewControllers].count > PAPActivityTabBarItemIndex) {
            ...
            [self.activityViewController notificationSetup:[UIApplication sharedApplication].applicationIconBadgeNumber];
        }
    }
}
