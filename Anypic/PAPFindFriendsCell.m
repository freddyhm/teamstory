...
- (void)setUser:(PFUser *)aUser {
    ...
    CGSize nameSize = ([nameString boundingRectWithSize:CGSizeMake(144.0f,0) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:16.0f], NSParagraphStyleAttributeName: paragraphStyle.copy} context:nil]).size;
    ...
    CGSize photoLabelSize = ([@"photos" boundingRectWithSize:CGSizeMake(144.0f,0) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:11.0f], NSParagraphStyleAttributeName: paragraphStyle.copy} context:nil]).size;
