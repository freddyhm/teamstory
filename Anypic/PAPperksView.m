...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [perksScrollView setContentSize:CGSizeMake(screenWidth, 1400.0f)];
        ...
        [content2_label_title setText:@"Deezer - All the music you love"];
        ...
        [content2_label_body setText:@"our favourite artists, albums, and tracks, plus\nnew discoveries waiting to be made."];
        ...
        [content3_label_title setText:@"Deezer - All the music you love"];
        ...
        UILabel *content3_label_body = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, 90.0f, 320.0f, 40.0f)];
        ...
        [content3_label_body setText:@"our favourite artists, albums, and tracks, plus\nnew discoveries waiting to be made."];
        ...
        [content4_label_title setText:@"Deezer - All the music you love"];
        ...
        UILabel *content4_label_body = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, 90.0f, 320.0f, 40.0f)];
        ...
        [content4_label_body setText:@"our favourite artists, albums, and tracks, plus\nnew discoveries waiting to be made."];
        ...
        UILabel *content5_label_title = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, 70.0f, 320.0f, 30.0f)];
        [content5_label_title setTextColor:[UIColor colorWithRed:79.0f/255.0f green:182.0f/255.0f blue:154.0f/255.0f alpha:1.0f]];
        [content5_label_title setText:@"Deezer - All the music you love"];
        ...
        [content5_label_body setText:@"our favourite artists, albums, and tracks, plus\nnew discoveries waiting to be made."];
        ...
        [content6_label_title setText:@"Deezer - All the music you love"];
        ...
        [content6_label_body setText:@"our favourite artists, albums, and tracks, plus\nnew discoveries waiting to be made."];
