...
- (UIView*) tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    UILabel *activityPointLabel = [[UILabel alloc] initWithFrame:CGRectMake(35.0f, 70.0f, 251.0f, 106.0f)];
    ...
    UILabel *earnLabel = [[UILabel alloc] initWithFrame:CGRectMake(73.0f, 174.0f, 48.0f, 23.0f)];
    ...
    UILabel *pointLabel = [[UILabel alloc] initWithFrame:CGRectMake(112.0f, 175.0f, 135.0f, 21.0f)];
    ...
    UILabel *restLabel = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, 193.0f, [UIScreen mainScreen].bounds.size.width, 42.0f)];
    ...
    UILabel *headerLabel = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, 264.0f, [UIScreen mainScreen].bounds.size.width, 50.0f)];
    headerLabel.backgroundColor = [UIColor colorWithWhite:0.9f alpha:1.0f];
    headerLabel.text = @"Most Active People on Teamstory";
    headerLabel.textColor = [UIColor colorWithWhite:0.75f alpha:1.0f];
    headerLabel.textAlignment = NSTextAlignmentCenter;
    [headerView addSubview:headerLabel];
    
    UIButton *cancelButton = [[UIButton alloc] initWithFrame:CGRectMake(266.0f, 30.0f, 46.0f, 37.0f)];
