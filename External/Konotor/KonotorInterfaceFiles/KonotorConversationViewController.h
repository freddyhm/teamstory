...
#define KONOTOR_MESSAGE_BACKGROUND_IMAGE_TOP_INSET_IMESSAGECALLOUT 18
...
#define KONOTOR_MESSAGE_BACKGROUND_IMAGE_SIDE_PADDING_IMESSAGE 12
...
#define KONOTOR_USERMESSAGE_TEXT_COLOR ([UIColor blackColor])
#define KONOTOR_OTHERMESSAGE_TEXT_COLOR ([UIColor blackColor])
#define KONOTOR_USERTIMESTAMP_COLOR ([UIColor darkGrayColor])
#define KONOTOR_OTHERTIMESTAMP_COLOR ([UIColor darkGrayColor])
#define KONOTOR_USERNAME_TEXT_COLOR ([UIColor darkGrayColor])
