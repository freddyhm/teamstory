...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource 'FlightRecorder/FlightRecorder.embeddedframework/FlightRecorder.framework/Versions/A/Resources/FECoreModel.momd/FECoreModel.mom'
  install_resource 'FlightRecorder/FlightRecorder.embeddedframework/FlightRecorder.framework/Versions/A/Resources/FECoreModel.momd/VersionInfo.plist'
